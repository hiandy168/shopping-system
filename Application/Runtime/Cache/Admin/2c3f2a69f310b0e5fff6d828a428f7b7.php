...
<body>
<h1>
    <span class="action-span"><a href="/shopping-system/Admin/Category/categoryList">商品分类</a></span>
            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$val): ?><option value="<<?php echo ($val["cat_id"]); ?>>" ><<?php echo (str_repeat('&nbsp;&nbsp;',$val["lev"])); ?>><<?php echo ($val["cat_name"]); ?>></option><?php endforeach; endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
