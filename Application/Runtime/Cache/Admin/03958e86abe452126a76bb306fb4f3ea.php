                    ...
                    <div id="turn-page">
                        ...
                        <span id="page-link">
                            ...
                            当前为第<select name="cur_page" id="curt_page" onchange="javascript:searchc(this.value,'a')">
                                <?php $__FOR_START_24153__=0;$__FOR_END_24153__=$pages["pageNum"];for($i=$__FOR_START_24153__;$i < $__FOR_END_24153__;$i+=1){ ?><option value="<?php echo ($i+1); ?>"><?php echo ($i+1); ?></option><?php } ?>
                            </select>页，可切换选择
                        </span>
                    </div>
                </td>
