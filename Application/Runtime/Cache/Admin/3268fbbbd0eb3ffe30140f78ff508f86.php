            ...
            <tr id="pagesfoot">
                <td colspan=12 style="text-align: center;font-size:16px;">
                    ...
                    <select name="cur_page" id="curt_page" onchange="javascript:searchc(this.value,'a')">
                        <?php $__FOR_START_20406__=0;$__FOR_END_20406__=$pages["pageNum"];for($i=$__FOR_START_20406__;$i < $__FOR_END_20406__;$i+=1){ ?><option value="<?php echo ($i+1); ?>"><?php echo ($i+1); ?></option><?php } ?>
                    </select>页，可切换选择
                </td>
            </tr>
        </table>
...
function resetdata(tag_id,data_list){
    ...
    for(var k=0;k<data_list.length;k++){
        ...
        var td12 = document.createElement("td");
            ...
            a1.title="查看";a1.href="/Admin/Goods/goodsView/id/"+data_list[k].id;
            a1.appendChild(img6);
            td12.appendChild(a1);
